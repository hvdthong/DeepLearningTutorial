...
class DBN:
    def __init__(self, num_visible, hidden_layers, options, learning_rate=0.1):
        ...
        for l in xrange(0, self.L - 1):
            r = RBM(num_visible=self.hidden_layers[l], num_hidden=self.hidden_layers[l + 1],
    ...
    def train(self, data, max_epochs=1000):
        ...
        for l in xrange(0, self.L - 1):
            ...
            for i in range(0, l):
                ...
                vis = hid
            (self.RBMs[l]).train(vis, max_epochs, self.options[l])  # something wrong here, need to recheck the code
...
class RBM:
    ...
    def _continuousLogistic(self, x):
        ...
        # return np.log(1 - (U * (1 - np.exp(x)))) / (x + 0.01)
